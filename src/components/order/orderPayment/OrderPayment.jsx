...
const OrderPayment = () => {
  ...
  const fetchLatestOrderId = async () => {
    try {
      const response = await fetch("https://api.gic-itc.top/api/getAllOrders", {
        method: "GET",
        headers: {
  ...
  const fetchCashierId = async () => {
    try {
      const response = await fetch("https://api.gic-itc.top/api/auth/me", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
  ...
  const handleCreateAnOrderClick = async () => {
    ...
    try {
      const response = await fetch("https://api.gic-itc.top/api/orders", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
                  ...
                  <div className="payment-table-body-top">
                    <div className="payment-table-image-title-price">
                      <div className="payment-table-item-image">
                        <img
                          src={`https://api.gic-itc.top/${item.image}`}
                          alt={item.title}
